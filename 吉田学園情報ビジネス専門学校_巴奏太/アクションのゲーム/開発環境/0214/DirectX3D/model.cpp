...
void InitModel(void)
{
	...
	{
		SetShadow(D3DXVECTOR3(g_aModelSetInfo[nCntModel].fPos[0], g_aModelSetInfo[nCntModel].fPos[1], g_aModelSetInfo[nCntModel].fPos[2]), g_aModel[g_aModelSetInfo[nCntModel].nType].vtxMax.x * SHADOW_SIZE_MULTIPLIER, g_aModel[g_aModelSetInfo[nCntModel].nType].vtxMax.z * SHADOW_SIZE_MULTIPLIER);
	}
}
